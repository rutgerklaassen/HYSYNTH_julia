...
_lr_productions = [
  ...
  ('action -> MOVE','action',1,'p_action','parser_for_synthesis.py',268),
  ('action -> TURN_RIGHT','action',1,'p_action','parser_for_synthesis.py',269),
  ('action -> TURN_LEFT','action',1,'p_action','parser_for_synthesis.py',270),
  ('action -> PICK_MARKER','action',1,'p_action','parser_for_synthesis.py',271),
  ('action -> PUT_MARKER','action',1,'p_action','parser_for_synthesis.py',272),
  ('cste -> INT','cste',1,'p_cste','parser_for_synthesis.py',281),
]
